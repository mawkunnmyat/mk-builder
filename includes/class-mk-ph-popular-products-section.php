<?php
/**
 * Mk Pharmacy Popular Products Section
 *
...
/**
 * Render callback for mk/ph-popular-products-section dynamic block.
 *
 ...
 * @return string
 */
function mk_render_ph_popular_products_section($attributes, $content, $block)
{
    if (!class_exists('WooCommerce')) {
        return '<!-- Mk Pharmacy Popular Products: WooCommerce not active. -->';
    }
    ...
    $defaults = array(
        ...
        'sectionTitle'      => __('Popular Products', 'mk-builder'),
        'sectionSubtitle'   => __('Trusted by our patients for daily wellness.', 'mk-builder'),
        'containerMaxWidth' => 1200,
        'containerPadding'  => 20,
        'showAddToCart'     => true,
        'addToCartLabel'    => __('Add to Cart', 'mk-builder'),
    ...
    ob_start();
    ?>
    <section class="ph-section mk-ph-popular-products-section" style="<?php echo esc_attr($section_style); ?>">
