...
/**
 * Render callback for mk/phy-facilities-section dynamic block.
 *
 ...
 */
function mk_render_phy_facilities_section($attributes, $content, $block)
{
    $defaults = array(
        'source'            => 'recent',
        'categoryId'        => 0,
    ...
    ?>
    <section
        class="phy-section mk-phy-facilities-section"
