<?php
/**
 * Mk Pharmacy Shop by Category Section
 *
...
/**
 * Render callback for mk/ph-shop-category-section dynamic block.
 *
 ...
 * @return string
 */
function mk_render_ph_shop_category_section($attributes, $content, $block)
{
    // Require WooCommerce for product_cat taxonomy.
    if (!class_exists('WooCommerce')) {
        return '<!-- Mk Pharmacy Shop Section: WooCommerce not active. -->';
    }
    ...
    $defaults = array(
        ...
        'sectionTitle'      => __('Shop by Category', 'mk-builder'),
        'sectionSubtitle'   => __('Browse our wide range of healthcare products.', 'mk-builder'),
    ...
    ob_start();
    ?>
    <section class="ph-section mk-ph-shop-category-section" style="<?php echo esc_attr($section_style); ?>">
        <div class="ph-container" style="<?php echo esc_attr($container_style); ?>">
            <?php if ($atts['showSectionHeader']) : ?>
                <div class="<?php echo esc_attr($header_class); ?> mk-ph-shop-category-section-header">
                    <?php if (!empty($atts['sectionTitle'])) : ?>
                        <h2 class="mk-ph-shop-category-section-title"><?php echo esc_html($atts['sectionTitle']); ?></h2>
                    <?php endif; ?>
                    <?php if (!empty($atts['sectionSubtitle'])) : ?>
                        <p class="mk-ph-shop-category-section-subtitle"><?php echo esc_html($atts['sectionSubtitle']); ?></p>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
