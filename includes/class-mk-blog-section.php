<?php
/**
 * Mk Blog Section – main blog layout.
 *
 ...
 * @return int
 */
function mk_blog_estimate_reading_time($post_id)
{
...
/**
 * Render callback for mk/blog-section dynamic block.
 *
 ...
 */
function mk_render_blog_section($attributes, $content, $block)
{
    $defaults = array(
        'postsPerPage'         => 4,
        'orderBy'              => 'date',
        ...
        'searchTitle'          => __('Search', 'mk-builder'),
        'showCategoriesWidget' => true,
        'categoriesTitle'      => __('Categories', 'mk-builder'),
        'categoriesInclude'    => '',
        'showRecentWidget'     => true,
        'recentTitle'          => __('Recent Posts', 'mk-builder'),
        'recentItems'          => 3,
        'recentSource'         => 'latest',
        'recentCategoryId'     => 0,
        'recentPostIds'        => '',
        'showTagsWidget'       => true,
        'tagsTitle'            => __('Popular Tags', 'mk-builder'),
        'tagsInclude'          => '',
        'excerptLength'        => 30,
        'readMoreLabel'        => __('Read More', 'mk-builder'),
    );
    ...
    ob_start();
    ?>
    <div class="blog-section wp-block-mk-blog-section" style="<?php echo esc_attr($section_style); ?>">
        <div
        ...
        >
            <div class="main-content">
                <?php if ($atts['showFeatured'] && $featured_post instanceof WP_Post) : ?>
                    ...
                    $tag_label = $terms && !is_wp_error($terms) ? $terms[0]->name : __('Blog', 'mk-builder');
                    ?>
                    ...
                    <div class="blog-grid">
                        ...
                        if (!empty($grid_posts)) :
                            foreach ($grid_posts as $post_obj) :
                                ...
                                $title     = get_the_title($post_id);
                                $terms     = get_the_terms($post_id, 'category');
                                $cat_name  = $terms && !is_wp_error($terms) ? $terms[0]->name : __('Blog', 'mk-builder');
                                $read_min  = mk_blog_estimate_reading_time($post_id);
                                ?>
                                        ...
                                        <div class="blog-meta">
                                            ...
                                            <span>
                                                ...
                                                printf(
                                                    ...
                                                    esc_html__('%d min read', 'mk-builder'),
                                                    (int) $read_min
                                                );
                                                ?>
                                            </span>
                            ...
                            ?>
                            <p><?php esc_html_e('No posts found.', 'mk-builder'); ?></p>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                        ...
                        <div class="widget widget-search">
                            ...
                            <form class="search-form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                                <input
                                    ...
                                    class="search-input"
                                    name="s"
                                    placeholder="<?php esc_attr_e('Search articles…', 'mk-builder'); ?>"
                                />
                                <button type="submit" class="search-btn">
                                    <i class="fas fa-search" aria-hidden="true"></i>
                                    <span class="screen-reader-text"><?php esc_html_e('Search', 'mk-builder'); ?></span>
                                </button>
                            </form>
                        </div>
                    <?php endif; ?>
