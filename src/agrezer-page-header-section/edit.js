...
export default function Edit({ attributes, setAttributes, isSelected }) {
  ...
  }), [backgroundColor, breadcrumbActiveColor, breadcrumbColor, containerMaxWidth, containerMinHeight, containerWidthPct, enableTractorAnimation, overlayOpacity, paddingBottom, paddingTop, titleColor, titleFontSize]);
