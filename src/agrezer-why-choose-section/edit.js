...
export default function Edit({ attributes, setAttributes, isSelected }) {
  ...
  }), [backgroundOverlayOpacity, bgGradientEndColor, bgGradientStartColor, enableParallax, filterBrightness, filterContrast, filterGrayscale, imageAnimationDelay, imageAnimationDuration, imageVerticalOffset, mediaBorderRadius, mediaDropShadow, mediaMaxWidthDesktop, mediaMaxWidthMobile, paddingBottom, paddingBottomMobile, paddingTop, paddingTopMobile, shapeVar, waveDecorationUrl, waveFlipHorizontal, waveFlipVertical, waveHeightDesktop, waveHeightMobile, waveOpacity]);
