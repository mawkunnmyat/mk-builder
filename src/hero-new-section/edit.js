		...
		<>
			{ isSelected && (
				<InspectorControls>
					...
					<PanelBody
						title={ __( 'Tagline & Heading', 'mk-builder' ) }
						initialOpen={ true }
					>
						<TextControl
						...
						<TextControl
							label={ __( 'Heading Line 1', 'mk-builder' ) }
							value={ headingLine1 }
							onChange={ ( val ) =>
						...
						<TextControl
							label={ __( 'Heading Line 2', 'mk-builder' ) }
							value={ headingLine2 }
							onChange={ ( val ) =>
					...
					>
						<TextControl
							label={ __( 'Hero Description', 'mk-builder' ) }
							value={ description }
							onChange={ ( val ) =>
					...
					<PanelBody
						title={ __( 'Primary Button', 'mk-builder' ) }
						initialOpen={ false }
					>
						<ToggleControl
							label={ __(
					...
					<PanelBody
						title={ __( 'Secondary Button', 'mk-builder' ) }
						initialOpen={ false }
					>
						<ToggleControl
							label={ __(
					...
					<PanelBody
						title={ __( 'Glass Card', 'mk-builder' ) }
						initialOpen={ false }
					>
						<ToggleControl
							label={ __( 'Show Glass Card', 'mk-builder' ) }
					...
					>
						...
						>
							<RichText
								...
								placeholder={ __( 'Line 1', 'mk-builder' ) }
								multiline={ false }
							/>
							<br />
							<RichText
							...
							<RichText
								...
								placeholder={ __( 'Line 2', 'mk-builder' ) }
								multiline={ false }
							/>
						</h1>
						<RichText
